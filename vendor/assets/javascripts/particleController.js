...
$(function(){
   ...
   display.start();
	...
	//'0,basic:Sv1(2000|1|0|0|1|E360,230:2,0:8:-1:0.10:4|F700,230:-140:8)'
      //particleSystem.addEmitter(new Point(360,230),Vector.fromAngle(0,2));
      //particleSystem.addField(new Point(700,230), -140);
	//'0,basic:Sv1(2000|0|0|0|1|
		//E500,275:1.3,-0:8:-1:3.14:4|
		//F650,275:-250|
		//F350,275:-250|
		//F500,125:-250|
		//F500,425:-250|
	   ...
	   //emitter.emissionRate = parseInt(parts.shift().valueOf());
   	  ...
   	  //particleSystem.addEmitter(new Point(500,275),Vector.fromAngle(-0,1.3));
	  //particleSystem.emitters.push(ParticleEmitter.fromString("2000|0|0|0|1|E500,275:1.3,-0:8:-1:3.14:4"));
	
	  var emitter = new ParticleEmitter();
      emitter.position     = new Point(500,275);
      emitter.velocity     = Vector.fromAngle(-0,1.3);
      emitter.size         = 0;
      emitter.particleLife = -1;
      emitter.spread       = 3.14;
      emitter.emissionRate = 4;
	  particleSystem.emitters.push(emitter);
      
      /*particleSystem.addField(new Point(650,275), -250);
      particleSystem.addField(new Point(350,275), -250);
      particleSystem.addField(new Point(500,125), -250);
      particleSystem.addField(new Point(500,425), -250);
      particleSystem.addField(new Point(606,381), -250);
      particleSystem.addField(new Point(606,169), -250);
      particleSystem.addField(new Point(397,381), -250);
      particleSystem.addField(new Point(397,169), -250);*/
      var pull = -250;
	  particleSystem.addField(new Point(650,275), pull); //R
      particleSystem.addField(new Point(350,275), pull); //L
      particleSystem.addField(new Point(500,125), pull);
      particleSystem.addField(new Point(500,425), pull);
      particleSystem.addField(new Point(606,381), pull);
      particleSystem.addField(new Point(606,169), pull);
      particleSystem.addField(new Point(397,381), pull);
      particleSystem.addField(new Point(397,169), pull);
	}
